...
1. **Học theo cụm, không học từ đơn.** Nhớ *"place an order"* thay vì nhớ riêng *place* và *order*. TOEIC không hỏi nghĩa của từ — nó hỏi từ nào đi với từ nào.
2. **Nghe trước, đọc sau.** Với mỗi từ mới: nghe phát âm 2–3 lần → nhắc lại → rồi mới nhìn nghĩa. Một nửa bài thi là Listening; từ bạn "biết mặt chữ" mà không nhận ra khi nghe thì vô dụng.
3. **Ôn theo chu kỳ giãn cách:** ngày 1 → ngày 3 → ngày 7 → ngày 14 → ngày 30. Dùng Anki hoặc Quizlet để tự động hóa việc này.
