...
- **Execution** — một lần chạy workflow: có ID, trạng thái (success/error/running), và **lưu dữ liệu vào/ra của từng node**. Mặc định n8n chạy ở *regular mode* (trong main process); *queue mode* để scale sẽ bàn ở [Bài 14](../kien-truc-n8n-ben-trong/).
