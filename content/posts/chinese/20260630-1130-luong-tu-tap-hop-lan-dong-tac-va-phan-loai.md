+++
date        = '2026-06-30T11:30:00+07:00'
draft       = false
title       = 'Lượng từ chỉ tập hợp, lần/động tác và phân loại'
slug        = 'luong-tu-tap-hop-lan-dong-tac-va-phan-loai'
summary     = 'Phần cuối series lượng từ tiếng Trung: lượng từ chỉ tập hợp (束, 串, 堆, 排, 层…), động lượng từ chỉ số lần (次, 遍, 回, 趟, 场…) và lượng từ phân loại trừu tượng (种, 类, 份…) — kèm Hán Việt, cách dùng và ví dụ.'
thumbnail   = '/images/series-luong-tu-tieng-trung/08-luong-tu-chi-tap-hop-lan-dong-tac-va-phan-loai.webp'
featured    = false
weight      = 8
categories  = ['chinese']
...
Phần cuối của [series tổng hợp lượng từ tiếng Trung](/series/tong-hop-luong-tu-tieng-trung/) gom ba nhóm còn lại: lượng từ chỉ **tập hợp** sự vật, **động lượng từ** đếm số lần hành động, và lượng từ **phân loại trừu tượng**.
...
Nhóm này đứng **sau động từ** để đếm số lần hành động (xem cách dùng ở [bài mở đầu](/posts/luong-tu-tieng-trung-la-gi-cach-dung/)).
