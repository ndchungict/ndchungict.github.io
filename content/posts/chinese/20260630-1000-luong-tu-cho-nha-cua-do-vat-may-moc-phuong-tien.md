...
draft       = false
title       = 'Lượng từ cho nhà cửa, đồ vật, máy móc và phương tiện'
slug        = 'luong-tu-cho-nha-cua-do-vat-may-moc-phuong-tien'
summary     = 'Phần 5 series lượng từ tiếng Trung: lượng từ cho công trình kiến trúc (座, 栋, 间), máy móc và phương tiện (台, 架, 辆, 部), đồ vật trong nhà và đồ thành bộ (件, 套, 副, 顶, 扇) — kèm Hán Việt, cách dùng và ví dụ.'
...
Nhóm lượng từ cho **đồ vật cụ thể** quanh ta: nhà cửa, công trình, máy móc, xe cộ và vật dụng trong nhà. Đây là phần 5 trong [series tổng hợp lượng từ tiếng Trung](/series/tong-hop-luong-tu-tieng-trung/).
...
Phần tiếp theo: [Lượng từ cho vật chứa và đơn vị đong đếm](/posts/luong-tu-cho-vat-chua-va-don-vi-dong-dem/).
